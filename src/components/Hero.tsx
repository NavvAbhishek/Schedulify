    ...
    <div className="bg-white">
      <div className="mx-auto pb-6">
        <div className="relative isolate overflow-hidden bg-white px-6 pt-10 md:pt-0 sm:px-16 lg:flex lg:gap-x-16 lg:px-24">
          <div className="mx-auto max-w-lg text-start lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            <h2 className="leading-tight text-5xl sm:text-4xl font-bold tracking-tight text-pink">
              Simplify timetable management and Organize day well
            </h2>
            <p className="mt-6 text-md leading-8 text-purple">
